...
# The train arrives and you hop on. Guess what time it is? It's showtime! There are 23 people on the train and each person gives the dancers 1.5 dollars. Write a method called pay_dancers that puts how much money they made. 
...
# There is also a really enthusiastic rider who keeps shouting "Everything is awesome!" Write a method called everything_is_awesome that puts everything is awesome 5 times. (Ruby has a times method that can help you do this.)
